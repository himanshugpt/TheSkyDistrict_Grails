        ...
        <div class="body">
            ...
            <div class="list">
                <table>
                    ...
                    <tbody>
                    <g:each in="${session.vendorInstanceList}" status="i" var="vendorInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        
                            
                         <td><g:link action="show" controller="vendor" id="${vendorInstance.id}">
                            ${fieldValue(bean: vendorInstance, field: "name")}</g:link></td>
            ...
            <div class="paginateButtons">
                <g:paginate total="${session.vendorInstanceTotal}" />
            </div>
        </div>
    </body>
</html>
