                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="tags"><g:message code="coupon.tags.label" default="Tags" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: couponInstance, field: 'tags', 'errors')}">
                                    <g:select name="tags" from="${com.sky.district.domain.Tag.list()}" multiple="yes" optionKey="id" size="5" value="${couponInstance?.tags*.id}" />
                                </td>
                            </tr>
