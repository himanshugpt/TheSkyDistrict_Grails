...
<%@ page import="com.sky.district.domain.Tag" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="coupons"><g:message code="tag.coupons.label" default="Coupons" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tagInstance, field: 'coupons', 'errors')}">
